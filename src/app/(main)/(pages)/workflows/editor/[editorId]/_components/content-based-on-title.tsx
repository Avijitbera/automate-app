...
import GoogleFileDetails from './google_file_details'
import GoogleDriveFiles from './google_drive_files'
      ...
      <Card>
        ...
        <div className="flex flex-col gap-3 px-6 py-3 pb-20">
          ...
          <Input
            ...
            onChange={(event) => null //onContentChange(nodeConnection, title, event)
            }
          />
